...
namespace Emscripten
{
	...
	DEFINE_INTRINSIC_FUNCTION1(env,prints,prints,none,i32,text)
	{
		puts("test the prints function");
	}
	...
	NativeTypes::i32 _fwritei32i32i32i32i32(NativeTypes::i32,NativeTypes::i32,NativeTypes::i32,NativeTypes::i32); 
	static Intrinsics::Function _fwritei32i32i32i32i32Function("env" "." "_fwrite",IR::FunctionType::get(IR::ResultType::i32,{IR::ValueType::i32,IR::ValueType::i32,IR::ValueType::i32,IR::ValueType::i32}),(void*)&_fwritei32i32i32i32i32); 
	NativeTypes::i32 _fwritei32i32i32i32i32(NativeTypes::i32 pointer,NativeTypes::i32 size,NativeTypes::i32 count,NativeTypes::i32 file)
 {
  return (I32)fwrite(memoryArrayPtr<U8>(emscriptenMemory,pointer,U64(size) * U64(count)),U64(size),U64(count), stdout);//vmFile(file));
 }
